  ...
  return (
    <div>
      ...
      <div className=" w-[55%] mx-auto pt-8">
        ...
        <h4 className="my-6 text-2xl">{type.item}</h4>
        <p className="mb-12">284 481 annonces</p>
        <ul>
          <li className="flex w-9/12 mb-4 pb-4 border-b-[1px] border-slate-300 ">
            <div className="h-[200px] w-[320px] rounded bg-slate-700"></div>
            <div className="pl-4 relative">
              <p className="mb-2 text-xl">Nom de l'article</p>
              <span className="flex mb-6">
                <p className="mr-6">10$</p>
                <p>Bon état</p>
              </span>
              ...
              <p className="absolute left-4 bottom-0 text-sm text-slate-400">
                Posté par Jacqueline à Bretignies-Sur-Orge le 15/07/24 à 12:24
              </p>
            </div>
          </li>
          <li className="flex w-9/12 mb-4 pb-4 border-b-[1px] border-slate-300 ">
